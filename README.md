...
`librarian-chef install`. To install with Librarian:
    ...
    cookbook 'user',
      :git => 'git://github.com/fnichol/chef-user.git', :ref => 'v0.2.4'
    END_OF_CHEFFILE
...
plugin:
    ...
    cd chef-repo
    knife cookbook github install fnichol/chef-user/v0.2.4
...
Server or Opscode Hosted Chef, then a tarball installation might fit the bill:
    ...
    curl -Ls https://github.com/fnichol/chef-user/tarball/v0.2.4 | tar xfz - && \
